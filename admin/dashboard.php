...
<caption><h1 align="center"><u>Admin Dashboard</u></h1></caption>
    ...
    <span style="margin-left: 150px"> <a href="dashboard.php?info=add_faculty"> <input type="button" value="Add Faculty" style="width: 160px;height: 50px;background-color: #fc0366;color: white;border-radius: 5px;font-weight: bold" ></a></span>
...
<div style="margin-top: 120px">
    ...
    <span style="margin-left: 570px"> <a href="dashboard.php?info=contact"> <input type="button" value="Contact Page" style="width: 160px;height: 50px;background-color: #fc0366;color: white;border-radius: 5px;font-weight: bold" ></a></span>

     <span style="margin-left: 240px"> <a href="logout.php"> <input type="button" value="Logout" style="width: 160px;height: 50px;background-color: green;color: white;border-radius: 5px;font-weight: bold" ></a></span>
